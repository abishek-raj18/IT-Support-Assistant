...
(function () {
    ...
    if (window.firebaseAPI && authBtn) {
        authBtn.addEventListener('click', () => {
            if (currentUser) {
                window.firebaseAPI.logoutUser();
            } else {
        ...
        window.firebaseAPI.onAuthChange((user) => {
            ...
            if (user) {
                ...
                authBtn.querySelector('span').textContent = 'Log Out';
                ...
                authBtn.querySelector('span').textContent = 'Log In';

                // Reset profile
                userName.textContent = 'Setup Auth';
